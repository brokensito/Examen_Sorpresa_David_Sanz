...
class Punto:
    ...
    def cuadrante(self):
        if self.valor_x==0 and self.valor_y!=0:
            cuadrante = "Esta situado sobre el eje Y"
            return cuadrante
        
        elif self.valor_x!=0 and self.valor_y==0:
            cuadrante = "Esta situado sobre el eje X"
            return cuadrante

        elif self.valor_x==0 and self.valor_y==0:
            cuadrante = "Esta situado sobre el ORIGEN"
            return cuadrante

        elif self.valor_x>0 and self.valor_y>0:
            cuadrante = "Esta en el PRIMER cuadrante "
            return cuadrante

        elif self.valor_x<0 and self.valor_y>0:
            cuadrante = "Esta en el SEGUNDO cuadrante "
            return cuadrante

        elif self.valor_x<0 and self.valor_y<0:
            cuadrante = "Esta en el TERCER cuadrante "
            return cuadrante

        elif self.valor_x>0 and self.valor_y<0:
            cuadrante = "Esta en el CUARTO cuadrante "
            return cuadrante
